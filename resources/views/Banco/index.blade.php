			...
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($banco as $ban)
				<tr>
					...
					<td>
						<a href="{{URL::action('BancoController@edit',$ban->id)}}"><button class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"> Editar</i></button></a>
                         <a href="" data-target="#modal-delete-{{$ban->id}}" data-toggle="modal"><button class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"> Eliminar</i></button></a>
					</td>
				</tr>
				@include('Banco.modal')
				@endforeach
