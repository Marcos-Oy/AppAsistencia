...
<div class="row">
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Establecimiento
            @if($rol == 'Administrador' || $rol == 'Habilitador'||$rol == 'Docente')	 
				<a href="Establecimiento/create"><button class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"> Nuevo</i></button></a>
			@endif
		</h3>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
               ...
               @foreach ($establecimiento as $esta)
				<tr>
					...
					<td>
						<a href="{{URL::action('EstablecimientoController@edit',$esta->idestablecimiento)}}"><button class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"> Editar</i></button></a>
                         <a href="" data-target="#modal-delete-{{$esta->idestablecimiento}}" data-toggle="modal"><button class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"> Eliminar</i></button></a>
					</td>
				</tr>
